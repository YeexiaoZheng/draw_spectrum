...
if __name__ == '__main__':
    ...
    for idx, records in enumerate(recses):
        print(((records['network size'] - records[y]) / records['average commit'] if AVG else (records['network size'] - records[y])) * 100)
        print((records[y] / records['average commit'] if AVG else records[y]) * 100)
